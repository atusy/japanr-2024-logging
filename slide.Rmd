...
## R-representation of a log record

```r
list(
  # basic info
  time = "2024-12-03 22:38:17",
  level = "DEBUG",
  ns = "japanr2024",

  # static message and a related value
  message = "Processing location",
  value = "tokyo",

  # various identifiers that describe the relationship between logs
  span_id = "01JE6BWEXSW65DD1EC858XMZQ3",
  session_id = "01JE6BWEWP0BAAFGPZTZ9GBNM6",
  trace_id = "01JE6BWEXF5F6HDD4YFZBP157F"
)
```
...
```{r, eval=FALSE}
# Configure
t <- tempfile() # or desired file path
logger::log_appender(logger::appender_stdout, index = 1)
logger::log_appender(logger::appender_file(t), index = 2)
logger::log_formatter(logger::formatter_json, index = 2)
logger::log_layout(logger::layout_json_parser(c("time", "level", "ns")), index = 2)
